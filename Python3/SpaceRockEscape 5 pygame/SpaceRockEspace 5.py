...
OnFire1 = pygame.image.load("OnFire1.png")
OnFire2 = pygame.image.load("OnFire2.png")
OnFire3 = pygame.image.load("OnFire3.png")
OnFire4 = pygame.image.load("OnFire4.png")
OnFire5 = pygame.image.load("OnFire5.png")
OnFire6 = pygame.image.load("OnFire6.png")
OnFire7 = pygame.image.load("OnFire7.png")
Fire_OnFire1 = pygame.image.load("Fire_OnFire1.png")
Fire_OnFire2 = pygame.image.load("Fire_OnFire2.png")
Fire_OnFire3 = pygame.image.load("Fire_OnFire3.png")
Fire_OnFire4 = pygame.image.load("Fire_OnFire4.png")
Fire_OnFire5 = pygame.image.load("Fire_OnFire5.png")
Fire_OnFire6 = pygame.image.load("Fire_OnFire6.png")
Fire_OnFire7 = pygame.image.load("Fire_OnFire7.png")
Fire_OnFire8 = pygame.image.load("Fire_OnFire8.png")
Fire_OnFire9 = pygame.image.load("Fire_OnFire9.png")
Fire_OnFire10 = pygame.image.load("Fire_OnFire10.png")
Fire_OnFire11 = pygame.image.load("Fire_OnFire11.png")
Fire_OnFire12 = pygame.image.load("Fire_OnFire12.png")
Fire_OnFire13 = pygame.image.load("Fire_OnFire13.png")
Fire_OnFire14 = pygame.image.load("Fire_OnFire14.png")
Fire_OnFire15 = pygame.image.load("Fire_OnFire15.png")
Fire_OnFire16 = pygame.image.load("Fire_OnFire16.png")
...
def move_Controller():
    ...
    if int(controller1.get_button(7)) == 1:
        if reload_cannon_counter > 0:
            reload_cannon_counter = reload_cannon_counter - 1
            Play_Reload_Sound_UPDATE()
...
def Start_Sounds():
    import pygame,time
    global soundObjFire
    global soundObjReload
    pygame.mixer.init()
    soundObjFire = pygame.mixer.Sound('Fire_Sound.wav')
    soundObjReload= pygame.mixer.Sound('Reload_Sound.wav')
def Play_Laser_Sound_UPDATE():
    global soundObjFire
    soundObjFire.play()
def Play_Reload_Sound_UPDATE():
    global soundObjReload
    soundObjReload.play()
            ...
            for frames in range(1,7):
                ...
                if controller1.get_button(5) == 1: #αν το button 5 γυρίσει Status True [R1]
                    ...
                    if reload_cannon_counter <= 120:
                        ...
                        bulletx = xspaceship + 90 #χ της σφαίρας ίδιο με του διαστημοπλοίου + 90 [ακριβώς πάνω απο το κανόνι]
                        bullety = yspaceship      #y της σφαίρας ιδιο με του διαστημοπλοίου
                        for i in range(1,16): #17 καρέ εκπυρσοκρότησης
                            time.sleep(0.005)
                            scrolling_BG_UPDATE() #κλήση της scrolling_BG_UPDATE
                            RockAttack_UPDATE() #κληση της RockAttack_UPDATE
                            bullety = bullety - 30 #μείωση του bullety κατα 20
                            exec("screen.blit(Fire_OnFire" + str(i) + ",(xspaceship,yspaceship))") # αποτύπωση διαστημοπλοίου
                            screen.blit(bullet,(bulletx,bullety)) #αποτύπωση σφαίρας
                            Bullet_on_Rock() #Κλήση της Bullet_on_Rock!
                            Spaceship_on_Rock()
                            check_spaceship_inlevel()
                ...
                check_spaceship_inlevel()
                show_bullet_remaining_UPDATE()
                exec("screen.blit(OnFire"+str(frames)+",(xspaceship,yspaceship)) #αποτύπωση διαστημοπλοίου [εκτος εκπυρσοκρότησης]")
                pygame.display.update() #UPDATE του buffer
