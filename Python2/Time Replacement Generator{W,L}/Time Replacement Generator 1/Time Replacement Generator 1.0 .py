def DrawFrame(Verb_b,typeof,Verb,Verb_s,Verb_ing,Verb_ed):
        if Verb_b == "i":
                ...
                print ""
                print "Κατάφαση>        ",Verb_b,Verb,"                                 ",Verb_b,"was",Verb_ing
                print "Ερώτηση >         Did",Verb_b,Verb,"?                             was",Verb_b,Verb_ing
                print "Άρνηση  >        ",Verb_b,"didn't",Verb,"                          ",Verb_b,"wasn't",Verb_ing
                print ""
                ...
                print ""
                print "Κατάφαση>        ",Verb_b,"have",Verb,"                            ",Verb_b+"'ve been",Verb_ing
                print "Ερώτηση >         Have",Verb_b,Verb,"                             Have",Verb_b,"been",Verb_ing
                print "Άρνηση  >        ",Verb_b,"haven't",Verb,"                         ",Verb_b,"haven't been",Verb_ing
                print ""
        ...
        if Verb_b =="you":
                ...
                print "                 Past Simple                              Past Continuous"
                print ""
                print "Κατάφαση>        ",Verb_b,Verb,"                                 ",Verb_b,"were",Verb_ing
                print "Ερώτηση >         Did",Verb_b,Verb,"?                             Were",Verb_b,Verb_ing
                print "Άρνηση  >        ",Verb_b,"didn't",Verb,"                          ",Verb_b,"weren't",Verb_ing
                print ""
                print "                 Used To                                  Be Going To"
                print ""
                print "Κατάφαση>        ",Verb_b," used to ",Verb,"                       ",Verb_b,"going to",Verb
        ...
        if Verb_b == "he" or Verb_b == "she" or Verb_b == "it":
                ...
                print "                 Present Perfect Simple                   Present Perfect Continuous"
                print ""
                print "Κατάφαση>        ",Verb_b,"has",Verb,"                            ",Verb_b+"'s been",Verb_ing
                print "Ερώτηση >         Has",Verb_b,Verb,"                             Has",Verb_b,"been",Verb_ing
                print "Άρνηση  >        ",Verb_b,"hasn't",Verb,"                         ",Verb_b,"hasn't been",Verb_ing
                print ""
                print "                 Past Perfect Simple                      Future Simple"
                print ""
                print "Κατάφαση>        ",Verb_b,"had",Verb_ed,"                        ",Verb_b,"will",Verb
