...
color 0A
title CMDG-R v.2.0
echo   .oooooo.   ooo        ooooo oooooooooo.     .oooooo.            ooooooooo.   
echo  d8P'  `Y8b  `88.       .888' `888'   `Y8b   d8P'  `Y8b           `888   `Y88. 
echo 888           888b     d'888   888      888 888                    888   .d88' 
echo 888           8 Y88. .P  888   888      888 888                    888ooo88P'  
echo 888           8  `888'   888   888      888 888     ooooo 8888888  888`88b.    
echo `88b    ooo   8    Y     888   888     d88' `88.    .88'           888  `88b.  
echo  `Y8bood8P'  o8o        o888o o888bood8P'    `Y8bood8P'           o888o  o888o 
echo _____________________________________________________________
echo welcome to CMDG-R
echo by El Sonador
echo version 2.0
echo _____________________________________________________________
echo this cmd-based programm helps you to learn and anderstand
echo all commands of Windows command promt
echo for information about Windows XP write "InfoXP"
echo for information about Windows Vista write "InfoV"
echo for information about Windows 7 write "Info7"
echo for information about Windows 8 write "Info8"
echo for terminate the programm Write "X"
:Restart
echo _____________________________________________________________
Set /P _dept=Cmd-GR  Ready ~
...
If /i "%_dept%"=="InfoXP" goto infoXP
If /i "%_dept%"=="InfoV" goto infoV
If /i "%_dept%"=="Info7" goto info7
If /i "%_dept%"=="Info8" goto info8
If /i "%_dept%"=="X" goto terminate
goto Fail
:Fail
echo command not regognized
goto Restart
:InfoXP
echo Windows XP is an operating system produced by Microsoft
echo for use on personal computers, including home and business 
echo desktops, laptops and media centers. First released to computer
echo manufacturers on August 24, 2001, it is the second most popular
echo version of Windows, based on installed user base. The name "XP"
echo is short for "eXPerience",highlighting the enhanced user experience.
goto Restart
:infoV
echo Windows Vista is an operating system released in several variations
echo by Microsoft for use on personal computers, including home and business
echo desktops, laptops, tablet PCs, and media center PCs. Prior to its announcement
echo on July 22, 2005, Windows Vista was known by its codename "Longhorn".
echo Development was completed on November 8, 2006, and over the following 
echo three months, it was released in stages to computer hardware and software
echo manufacturers, business customers and retail channels. On January 30, 2007,
echo it was released worldwide[5] and was made available for purchase and download 
echo from Microsoft's website.[6] The release of Windows Vista came more than five
echo years after the introduction of its predecessor, Windows XP, the longest time
echo span between successive releases of Microsoft Windows desktop operating
echo systems. It was succeeded by Windows 7, which was released to manufacturing 
echo on July 22, 2009 and released worldwide for retail on October 22, 2009.
:info7
echo Windows 7 is an operating system produced by Microsoft for use on personal 
echo computers, including home and business desktops, laptops, netbooks, 
echo tablet PCs, and media center PCs;[5] Windows 7 was released to
echo manufacturing on July 22, 2009,[6] and reached general retail availability 
echo worldwide on October 22, 2009,[7] less than three years after the release 
echo of its predecessor, Windows Vista. Windows 7's server counterpart, 
echo Windows Server 2008 R2, was released at the same time. Windows 7 is 
echo succeeded by Windows 8, released on 26 October 2012.
goto restart
:info8
echo Windows 8 is the current release of the Windows operating system, produced 
echo by Microsoft for use on personal computers, including home and business
echo desktops, laptops, tablets, and home theater PCs. Development of Windows
echo 8 started before the release of its predecessor in 2009. Its existence was
echo first announced at CES 2011, and followed by the release of three pre-release
echo versions from September 2011 to May 2012. The operating system was 
echo released to manufacturing on August 1, 2012, and was released for general 
echo availability on October 26, 2012.[3]
goto restart
:Append
